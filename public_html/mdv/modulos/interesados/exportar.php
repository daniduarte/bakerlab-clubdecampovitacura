<?php
	...
	header("content-disposition: attachment;filename=Mensajes de Contacto - Interesados Nivel Alto.xls");
...
<?php        
    if(Filas("contacto","interesado = 1 order by id DESC") > 0)
    {
	    $data        = Datos("contacto","interesado = 1 order by id DESC","*");
?>

<?php
	...
	header("content-disposition: attachment;filename=Visitas Agendadas.xls");
...
<?php        
    if(Filas("agendar","1 order by id DESC") > 0)
    {
	    $data        = Datos("agendar","1 order by id DESC","*");
?>
        <table id="tabla" style="width:100%;" border="1"> 
            ...
            ?>
                <tr> 
                    ...
                    <td><?=date("d-m-Y",strtotime($row['visita']));?></td>   

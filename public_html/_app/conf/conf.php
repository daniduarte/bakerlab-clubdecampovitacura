<?php	
	...
	define("_site", "");
	define("_port", "");
	define("_web", "https://".$_SERVER["SERVER_NAME"]._port._site);
	// define("_web", "http://localhost:1234/");
	...
	if(_modeLocal)
	{
		define("_host","db-mysql-nyc3-49753-do-user-6393692-0.b.db.ondigitalocean.com:25060");
		define("_user","clubdecampovitacura");
		define("_pass","AVNS_wRrO3bPsrNvHjbsIasZ");
		define("_imgApiURL","");
	}
	else
	{

...
function closefb ()
        ...
        $(document).ready(function(){	        
            ...
            if(window.innerWidth <= 480)
            {
             ...
             //   $.fancybox.open(' <div id="" > <a href="#contacto" style="outline:0px" onClick="closefb()" > <img src="<?=_static . '/img/popupabril08.jpg?v=2'?>" style="width:900px;" class="img-responsive" />  </a> </div>'); 
    ...
    <script>
	    ...
	    if(splitted[1] == 'masterplan')
	    {
		    $(document).ready(function()
		    {
			   scrollToAnchor('#masterplan',130); 
		    });
		}

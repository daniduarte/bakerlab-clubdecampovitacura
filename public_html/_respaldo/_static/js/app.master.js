...
function cargar_cotizador()
{
	...
	{
		$('#planokm').html('<iframe id="framecotizador" src="http://www.comercialinmobiliarias.cl/cotizador_web_new/cotizador/index.php?id_subagrupaciones=1&key=ffv"></iframe>');	
	}
	else
	{
		$('#planokm').html('<iframe id="framecotizador" src="http://www.comercialinmobiliarias.cl/cotizador_web_new/cotizador/index.php?id_subagrupaciones=2&key=ffv"></iframe>');	
	}	
}

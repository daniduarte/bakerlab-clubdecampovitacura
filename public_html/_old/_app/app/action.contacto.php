...
<html>
	...
	<body>
		<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width: 600px;border:1px solid #DDD;">
					...
					<table style="width:80%;margin-left:10%;">
						<tr>
							<td style="line-height: 20px;font-size: 13px;">
								...
								Próximamente comenzaremos la pre venta.<br><br>
								¡Pronto te sorprenderemos!
							</td>							
						</tr>
					</table>
				</td>
			...
			<tr>
				<td align="center">
					<a href="http://www.clubdecampovitacura.cl/confirmar-inscripcion/?confirmar=<?=$_POST['email'];?>"><img src="http://clubdecampovitacura.cl/_static/img/boton-mail.jpg" style="max-width: 600px;margin-top: 15px; margin-bottom: 15px;"></a>
				</td>
			</tr>
			<tr>
				<td align="center">
...
<?php
	...
	// Envío
	mail($_POST['email'],'Gracias por su inscripción en Club de Campo, Vitacura', $page, $cabeceras);	
?>

<div class="col-sm-2"></div>
<div class="col-sm-10 text-center" style="padding: 60px 0;padding-bottom: 75px;">
	<h3 style="color: #4f4f4f;">¡Gracias por Inscribirte!</h3>
	<p style="color: #4f4f4f;">Tu mensaje ha sido recibido.</p>
</div>